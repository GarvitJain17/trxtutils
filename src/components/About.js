...
// })
let mystyle={
  color:props.mode==='dark'?'white':'#141234',
  backgroundColor:props.mode ==='dark'?'#141234':'white',
  border:'2px solid',
  borderColor:props.mode==='dark'?'white':'#141234'
}

  return (
    <div className="container" /*style={mystyle}*/>
        <h2 className='my-3 'style={{color:props.mode==='dark'?'white':'#141234'}} >About Us</h2>
